    ...
    <div class="card-body">
      <form action="{{ route('kelas.update', $kela->id) }}" method="POST">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="tahun_ajar" name="tahun_ajar" value="{{ $kela->tahun_ajar }}" required>
        </div>
        <div class="mb-3">
          <label for="class_name" class="form-label">Nama Kelas</label>
          <input type="text" class="form-control" id="class_name" name="class_name" value="{{ $kela->class_name }}" required>
        </div>
        <div class="mb-3">
